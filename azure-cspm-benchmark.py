...
Assists with provisioning calculations by retrieving a count of all billable
resources attached to an Azure subscription.
 
Author: Joshua Hiller
Email: joshua.hiller@crowdstrike.com
